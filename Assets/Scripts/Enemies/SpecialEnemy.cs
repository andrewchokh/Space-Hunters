...
public class SpecialEnemy : MonoBehaviour
{
    ...
    public float minDelayBeforeShooting = 1000;
    public float maxDelayBeforeShooting = 3000;
    ...
    void Fire()
    {
        if(transform.position.x < 7.5f)
        {
            ...
            {
                fireRate = Random.Range(minDelayBeforeShooting, maxDelayBeforeShooting);
                ...
                Vector2 direction = myPos - (Vector2)enemy.position; //get the direction to the target
